...
if ( !function_exists( 'fire_department_template_news_portfolio_theme_setup' ) ) {
	add_action( 'fire_department_action_before_init_theme', 'fire_department_template_news_portfolio_theme_setup', 1 );
	function fire_department_template_news_portfolio_theme_setup() {
		fire_department_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'fire-department'),
...
// Template output
if ( !function_exists( 'fire_department_template_news_portfolio_output' ) ) {
	function fire_department_template_news_portfolio_output($post_options, $post_data) {
