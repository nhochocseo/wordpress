...
if ( !function_exists( 'fire_department_template_matches_2_theme_setup' ) ) {
	add_action( 'fire_department_action_before_init_theme', 'fire_department_template_matches_2_theme_setup', 1 );
	function fire_department_template_matches_2_theme_setup() {
		fire_department_add_template(array(
			'layout' => 'matches-2',
			'template' => 'matches-2',
			'mode'   => 'matches',
			'title'  => esc_html__('Matches /Style 2/', 'fire-department'),
...
// Template output
if ( !function_exists( 'fire_department_template_matches_2_output' ) ) {
	function fire_department_template_matches_2_output($post_options, $post_data) {
		$show_title = true;
