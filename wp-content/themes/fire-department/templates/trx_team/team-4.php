...
if ( !function_exists( 'fire_department_template_team_4_theme_setup' ) ) {
	add_action( 'fire_department_action_before_init_theme', 'fire_department_template_team_4_theme_setup', 1 );
	function fire_department_template_team_4_theme_setup() {
		fire_department_add_template(array(
			'layout' => 'team-4',
			'template' => 'team-4',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 4/', 'fire-department'),
...
// Template output
if ( !function_exists( 'fire_department_template_team_4_output' ) ) {
	function fire_department_template_team_4_output($post_options, $post_data) {
		$show_title = true;
