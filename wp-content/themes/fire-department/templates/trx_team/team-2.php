...
if ( !function_exists( 'fire_department_template_team_2_theme_setup' ) ) {
	add_action( 'fire_department_action_before_init_theme', 'fire_department_template_team_2_theme_setup', 1 );
	function fire_department_template_team_2_theme_setup() {
		fire_department_add_template(array(
			'layout' => 'team-2',
			'template' => 'team-2',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 2/', 'fire-department'),
...
// Template output
if ( !function_exists( 'fire_department_template_team_2_output' ) ) {
	function fire_department_template_team_2_output($post_options, $post_data) {
		$show_title = true;
		...
		?>
			...
			><div class="sc_team_item_avatar column-2_5">
					<?php fire_department_show_layout($post_options['photo']); ?>
