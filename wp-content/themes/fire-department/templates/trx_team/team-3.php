...
if ( !function_exists( 'fire_department_template_team_3_theme_setup' ) ) {
	add_action( 'fire_department_action_before_init_theme', 'fire_department_template_team_3_theme_setup', 1 );
	function fire_department_template_team_3_theme_setup() {
		fire_department_add_template(array(
			'layout' => 'team-3',
			'template' => 'team-3',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 3/', 'fire-department'),
...
// Template output
if ( !function_exists( 'fire_department_template_team_3_output' ) ) {
	function fire_department_template_team_3_output($post_options, $post_data) {
		$show_title = true;
		...
		?>
			<div<?php echo !empty($post_options['tag_id']) ? ' id="'.esc_attr($post_options['tag_id']).'"' : ''; ?>
				...
				<div class="sc_team_item_avatar"><?php fire_department_show_layout($post_options['photo']); ?>
					<div class="sc_team_item_hover">
						<div class="sc_team_item_socials"><?php fire_department_show_layout($post_options['socials']); ?></div>
					</div>
				</div>
