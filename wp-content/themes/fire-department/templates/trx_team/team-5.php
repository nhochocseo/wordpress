...
if ( !function_exists( 'fire_department_template_team_5_theme_setup' ) ) {
	add_action( 'fire_department_action_before_init_theme', 'fire_department_template_team_5_theme_setup', 1 );
	function fire_department_template_team_5_theme_setup() {
		fire_department_add_template(array(
			'layout' => 'team-5',
			'template' => 'team-5',
			'mode'   => 'team',
			/*'container_classes' => 'sc_slider_nopagination sc_slider_controls sc_slider_controls_bottom',*/
			'title'  => esc_html__('Team /Style 5/', 'fire-department'),
...
// Template output
if ( !function_exists( 'fire_department_template_team_5_output' ) ) {
	function fire_department_template_team_5_output($post_options, $post_data) {
		$show_title = true;
		...
		?>
			<div<?php echo !empty($post_options['tag_id']) ? ' id="'.esc_attr($post_options['tag_id']).'"' : ''; ?>
				...
				<div class="sc_team_item_info">
					...
					<div class="sc_team_item_description"><?php echo trim(fire_department_strshort($post_data['post_excerpt'], 300 )); ?></div>
