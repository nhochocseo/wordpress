...
if ( !function_exists( 'fire_department_template_single_matches_theme_setup' ) ) {
	add_action( 'fire_department_action_before_init_theme', 'fire_department_template_single_matches_theme_setup', 1 );
	function fire_department_template_single_matches_theme_setup() {
		fire_department_add_template(array(
			'layout' => 'single-matches',
			'mode'   => 'single_matches',
			'need_content' => true,
			'need_terms' => true,
			'title'  => esc_html__('Single matches', 'fire-department'),
...
// Template output
if ( !function_exists( 'fire_department_template_single_matches_output' ) ) {
	function fire_department_template_single_matches_output($post_options, $post_data) {
