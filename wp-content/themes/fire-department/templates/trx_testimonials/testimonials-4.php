...
if ( !function_exists( 'fire_department_template_testimonials_4_theme_setup' ) ) {
	add_action( 'fire_department_action_before_init_theme', 'fire_department_template_testimonials_4_theme_setup', 1 );
	function fire_department_template_testimonials_4_theme_setup() {
		fire_department_add_template(array(
			'layout' => 'testimonials-4',
			'template' => 'testimonials-4',
			'mode'   => 'testimonials',
			'title'  => esc_html__('Testimonials /Style 4/', 'fire-department'),
...
// Template output
if ( !function_exists( 'fire_department_template_testimonials_4_output' ) ) {
	function fire_department_template_testimonials_4_output($post_options, $post_data) {
		$show_title = true;
