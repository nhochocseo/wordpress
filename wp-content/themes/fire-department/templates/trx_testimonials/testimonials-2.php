...
if ( !function_exists( 'fire_department_template_testimonials_2_theme_setup' ) ) {
	add_action( 'fire_department_action_before_init_theme', 'fire_department_template_testimonials_2_theme_setup', 1 );
	function fire_department_template_testimonials_2_theme_setup() {
		fire_department_add_template(array(
			...
			'title'  => esc_html__('Testimonials /Style 2/', 'fire-department'),
			'w'		 => '',
			'h'		 => ''
		));
	}
...
// Template output
if ( !function_exists( 'fire_department_template_testimonials_2_output' ) ) {
	function fire_department_template_testimonials_2_output($post_options, $post_data) {
		$show_title = true;
