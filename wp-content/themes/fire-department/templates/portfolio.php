...
if ( !function_exists( 'fire_department_template_portfolio_theme_setup' ) ) {
	add_action( 'fire_department_action_before_init_theme', 'fire_department_template_portfolio_theme_setup', 1 );
	function fire_department_template_portfolio_theme_setup() {
		fire_department_add_template(array(
			'layout' => 'portfolio_2',
			'template' => 'portfolio',
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile (with hovers, different height) /2 columns/', 'fire-department'),
		...
		fire_department_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile /3 columns/', 'fire-department'),
		...
		fire_department_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile /4 columns/', 'fire-department'),
		...
		fire_department_add_template(array(
			...
			'title'  => esc_html__('Grid tile (with hovers, equal height) /2 columns/', 'fire-department'),
		...
		fire_department_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Grid tile /3 columns/', 'fire-department'),
		...
		fire_department_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Grid tile /4 columns/', 'fire-department'),
		...
		fire_department_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile (with hovers, width=height) /2 columns/', 'fire-department'),
			'thumb_title'  => esc_html__('Large square image (crop)', 'fire-department'),
			'w'		 => 870,
			'h' 	 => 870
		));
		fire_department_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile /3 columns/', 'fire-department'),
		...
		fire_department_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile /4 columns/', 'fire-department'),
			'thumb_title'  => esc_html__('Small square image (crop)', 'fire-department'),
			'w'		 => 300,
			'h'		 => 300
		));
		fire_department_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored excerpt', 'fire-department'),
			'thumb_title'  => esc_html__('Small square image (crop)', 'fire-department'),
			'w'		 => 300,
			'h'		 => 300
		));
		fire_department_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile (with hovers, width=height) /2 columns/', 'fire-department'),
			'thumb_title'  => esc_html__('Large square image (crop)', 'fire-department'),
			'w'		 => 870,
			'h' 	 => 870
		));
		fire_department_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile /3 columns/', 'fire-department'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'fire-department'),
			'w'		 => 390,
			'h'		 => 390
		));
		fire_department_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile /4 columns/', 'fire-department'),
			'thumb_title'  => esc_html__('Small square image (crop)', 'fire-department'),
			'w'		 => 300,
			'h'		 => 300
		));
		fire_department_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /2 columns/', 'fire-department'),
			'thumb_title'  => esc_html__('Large square image (crop)', 'fire-department'),
			'w'		 => 870,
			'h' 	 => 870
		));
		fire_department_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /3 columns/', 'fire-department'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'fire-department'),
			'w'		 => 390,
			'h'		 => 390
		));
		fire_department_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /4 columns/', 'fire-department'),
			'thumb_title'  => esc_html__('Small square image (crop)', 'fire-department'),
			'w'		 => 300,
			'h'		 => 300
		));
		fire_department_add_template(array(
			...
			'title'  => esc_html__('Alternative grid (with hovers) /2 columns/', 'fire-department'),
			'thumb_title'  => esc_html__('Large square image (crop)', 'fire-department'),
			'w'		 => 870,
			'h' 	 => 870
		));
		fire_department_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'small_margins',
			'title'  => esc_html__('Alternative grid /3 columns/', 'fire-department'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'fire-department'),
			'w'		 => 390,
			'h'		 => 390
		));
		fire_department_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'small_margins',
			'title'  => esc_html__('Alternative grid /4 columns/', 'fire-department'),
			'thumb_title'  => esc_html__('Small square image (crop)', 'fire-department'),
			'w'		 => 300,
			'h'		 => 300
		));
		// Add template specific scripts
		add_action('fire_department_action_blog_scripts', 'fire_department_template_portfolio_add_scripts');
	}
}

// Add template specific scripts
if (!function_exists('fire_department_template_portfolio_add_scripts')) {
	//add_action('fire_department_action_blog_scripts', 'fire_department_template_portfolio_add_scripts');
	function fire_department_template_portfolio_add_scripts($style) {
		if (fire_department_substr($style, 0, 10) == 'portfolio_' 
			|| fire_department_substr($style, 0, 5) == 'grid_' 
			|| fire_department_substr($style, 0, 7) == 'square_' 
			|| fire_department_substr($style, 0, 6) == 'short_'
			|| fire_department_substr($style, 0, 6) == 'alter_' 
			|| fire_department_substr($style, 0, 8) == 'colored_') {
...
// Template output
if ( !function_exists( 'fire_department_template_portfolio_output' ) ) {
	function fire_department_template_portfolio_output($post_options, $post_data) {
		...
		if ($style == 'colored' && $columns==1) {				// colored excerpt style (1 column)
			...
			<div class="isotope_item isotope_item_colored isotope_item_colored_1 isotope_column_1
						...
						?>">
				<<?php fire_department_show_layout($tag); ?> class="post_item post_item_colored post_item_colored_1
					...
					<div class="post_content isotope_item_content">
						<div class="post_featured img">
							...
							fire_department_show_layout($post_data['post_thumb'], $link_start, $link_end);
						...
						<div class="post_description clearfix">
							...
							if ($post_data['post_type'] == 'matches'){
								...
								echo '<div class="match_date">'
										. (!empty($post_meta['match_date']) && !fire_department_param_is_inherit($post_meta['match_date']) ?  date("d M", strtotime($post_meta['match_date'])) : '')
										. (!empty($post_meta['match_time']) && !fire_department_param_is_inherit($post_meta['match_time']) ?  ' ' . trim($post_meta['match_time']) : '')
									.'</div>';
								?>
							...
							?>
							<h5 class="post_title"><?php fire_department_show_layout($post_data['post_title'] . ($post_data['post_type'] == 'matches' ? ': ' . trim($post_meta['match_player_1']) . ' - ' . trim($post_meta['match_player_2']) : ''), $link_start, $link_end); ?></h5>
							<?php
							if ($post_data['post_type'] == 'players'){
								// Player information
								echo '<div class="player_info">'
										. (!empty($post_meta['player_country']) && !fire_department_param_is_inherit($post_meta['player_country']) ? '<span class="player_country">'. esc_html__( 'Country: ', 'fire-department' ) .''. fire_department_get_list_countries(false,$post_meta['player_country']) . '</span>' : '')
										. (!empty($post_meta['player_club']) && !fire_department_param_is_inherit($post_meta['player_club']) ? '<span class="player_club">'. esc_html__( 'Club: ', 'fire-department' ) .''. trim($post_meta['player_club']) .'</span>' : '')
										. (!empty($post_meta['player_age']) && !fire_department_param_is_inherit($post_meta['player_age']) && $post_meta['player_type'] == 'player' ? '<span class="player_age">'. esc_html__( 'Age: ', 'fire-department' ) .''. trim($post_meta['player_age']) .'</span>' : '')
									.'</div>';
							}
							...
							fire_department_show_layout($reviews_summary); ?>
							<div class="post_descr">
								<?php fire_department_show_layout($post_data['post_excerpt']); ?>
							</div>
							<?php if ($post_data['post_link'] != '') { ?>
								<div class="post_buttons">
									<?php fire_department_show_layout(fire_department_sc_button(array(
																		'size'=>'small',
																		'link'=>$post_data['post_link']
																		),
																		esc_html__('LEARN MORE', 'fire-department'))); ?>
								</div>
							<?php } ?>
						</div>
					</div>				<!-- /.post_content -->
			...
			if ($style=='alter') {
				...
				$alter_size = explode('_', fire_department_get_custom_option('alter_thumb_size', '1_1', $post_data['post_id'], $post_data['post_type']));	// !!!!!! Get option from specified post
				$alter_size[0] = max(1, $alter_size[0]);
				$alter_size[1] = max(1, empty($alter_size[1]) ? 1 : $alter_size[1]);
				$post_data['post_thumb'] = fire_department_get_resized_image_tag($post_data['post_attachment'], 
					 ...
					 ?>">
						...
						if ($style!='colored') {
							...
							<div class="post_info_wrap info"><div class="info-back">
								...
								<?php
								if ($show_title) {
									?><h4 class="post_title"><?php fire_department_show_layout($post_data['post_title'], $link_start, $link_end); ?></h4><?php
								}
								?>
								...
								<?php
									if ($post_data['post_protected']) {
										fire_department_show_layout($post_data['post_excerpt'], $link_start, $link_end);
									} else {
										...
										if ($post_data['post_excerpt']) {
											echo in_array($post_data['post_format'], array('quote', 'link', 'chat', 'aside', 'status'))
												...
												: '<p>' . ($link_start)
													. (fire_department_strpos($post_options['hover'], 'square')!==false
														? strip_tags($post_data['post_excerpt'])
														: trim(fire_department_strshort($post_data['post_excerpt'], isset($post_options['descr']) ? $post_options['descr'] : fire_department_get_custom_option('post_excerpt_maxlength_masonry')))
														)
													. ($link_end) . '</p>';
										}
										if ($post_data['post_link'] != '') {
											...
											if (!fire_department_param_is_off($post_options['readmore']) && !in_array($post_data['post_format'], array('quote', 'link', 'chat', 'aside', 'status'))) {
												?><a href="<?php echo esc_url($post_data['post_link']); ?>" class="post_readmore"><span class="post_readmore_label"><?php fire_department_show_layout($post_options['readmore']); ?></span></a><?php
											}
											?></p><?php
										}
									}
