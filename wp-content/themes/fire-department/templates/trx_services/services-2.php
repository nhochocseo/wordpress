...
if ( !function_exists( 'fire_department_template_services_2_theme_setup' ) ) {
	add_action( 'fire_department_action_before_init_theme', 'fire_department_template_services_2_theme_setup', 1 );
	function fire_department_template_services_2_theme_setup() {
		fire_department_add_template(array(
			'layout' => 'services-2',
			'template' => 'services-2',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 2/', 'fire-department'),
...
// Template output
if ( !function_exists( 'fire_department_template_services_2_output' ) ) {
	function fire_department_template_services_2_output($post_options, $post_data) {
