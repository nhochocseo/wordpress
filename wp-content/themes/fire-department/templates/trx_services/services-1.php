...
if ( !function_exists( 'fire_department_template_services_1_theme_setup' ) ) {
	add_action( 'fire_department_action_before_init_theme', 'fire_department_template_services_1_theme_setup', 1 );
	function fire_department_template_services_1_theme_setup() {
		fire_department_add_template(array(
			'layout' => 'services-1',
			'template' => 'services-1',
			'mode'   => 'services',
			'title'  => esc_html__('Services /Style 1/', 'fire-department'),
...
// Template output
if ( !function_exists( 'fire_department_template_services_1_output' ) ) {
	function fire_department_template_services_1_output($post_options, $post_data) {
